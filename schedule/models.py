...
class RinkSchedule(models.Model):
    ...
    event = models.CharField(max_length=50, help_text="Field format for two teams: Put home team first and separate with \' vs \', a space then, lowercase vs, then a space")
