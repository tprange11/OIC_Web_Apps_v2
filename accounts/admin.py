...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ['user_name', 'open_hockey_email', 'stick_and_puck_email', 'figure_skating_email', 'thane_storck_email', 'adult_skills_email', 'mike_schultz_email']
    readonly_fields = ['open_hockey_email', 'stick_and_puck_email', 'figure_skating_email', 'thane_storck_email', 'adult_skills_email', 'mike_schultz_email']
