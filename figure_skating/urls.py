...
urlpatterns = [
    ...
    path('remove_skater/<int:pk>/', views.DeleteFigureSkaterView.as_view(), name='remove-skater'),
    ...
    path('session/remove/<int:pk>/', views.DeleteFigureSkatingSessionView.as_view(), name='session-remove'),
