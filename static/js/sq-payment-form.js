function onGetCardNonce(event) {
    ...
    // Added by Brian Christensen, shows spinner after form submission
    document.querySelector("#pay-now-spinner").style.display = "block";
    // Added by Brian Christensen, hide Pay Now Button
    document.querySelector("#sq-creditcard").style.display = "none";
